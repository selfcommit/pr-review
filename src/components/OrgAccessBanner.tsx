...
function OrgAccessBanner({ orgAccess, onSwitchToOrgsTab }: OrgAccessBannerProps) {
  ...
  if (dismissed || orgAccess.loading || orgAccess.memberOrgs.length > 0) return null
      ...
      <div className="org-access-banner-content">
        ...
        <div className="org-access-banner-body">
          <p className="org-access-banner-text">
            <strong>No organizations detected.</strong>{' '}
            If you belong to GitHub organizations, check the Organizations tab for details.
          </p>
